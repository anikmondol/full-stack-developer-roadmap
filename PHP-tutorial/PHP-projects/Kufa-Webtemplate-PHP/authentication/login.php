        ...
        <div class="app-auth-container">
            ...
            <form action="login_post.php" method="post">
                ...
                <div class="auth-credentials m-b-xxl">
                    ...
                    <input name="email" type="email" class="form-control <?= (isset($_SESSION["email_error"])) ? "is-invalid" : ""; ?>  m-b-md" id="signInEmail" aria-describedby="signInEmail" placeholder="example@neptune.com" value="<?= (isset($_SESSION["old_email"])) ? $_SESSION["old_email"] : "";
                    ...
                    <input name="password" type="password" class="form-control <?= (isset($_SESSION["password_error"])) ? "is-invalid" : ""; ?> " id="signInPassword" aria-describedby="signInPassword" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" value="<?= (isset($_SESSION["old_password"])) ? $_SESSION["old_password"] : "";
